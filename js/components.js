      ...
      <div class="header-inner">
        ...
        <div class="header-actions">
          <div class="header-search">
            ...
            <button onclick="handleTopSearch()">🔍</button>
          </div>
          <button class="wishlist-btn" title="Saved items" onclick="showBuyToast('Wishlist is not yet available in this prototype.')">♡</button>
